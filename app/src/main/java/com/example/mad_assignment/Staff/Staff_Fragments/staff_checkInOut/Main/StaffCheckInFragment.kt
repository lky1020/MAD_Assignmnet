...
class StaffCheckInFragment : Fragment(), DatePickerDialog.OnDateSetListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.staff_fragment_check_in, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val recyclerView: RecyclerView = view.findViewById(R.id.rv_staff_check_in)
        ...
        tvDate.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                if (!tvDate.text.equals("Select Date")) {
                    displayCheckInRV(view, recyclerView)
                }
            }
        })
    ...
    private fun displayCheckInRV(view: View, recyclerView: RecyclerView){
        if(activity != null){
            ...
            staffCheckInOutModel.retrieveCheckInOutFromDB("paid", tvDate.text.toString())
