package com.example.mad_assignment.Staff.facility.Adapter
...
import com.example.mad_assignment.Staff.facility.Main.ManageFacilityDetails
    ...
    RecyclerView.Adapter<ManageFacilityMenuAdapter.RecyclerViewHolder>() {
        ...
        override fun onBindViewHolder(holder: RecyclerViewHolder, position: Int) {
            ...
            holder.itemView.setOnClickListener {
                ...
                val gson = Gson()
                val intent = Intent(mContext, ManageFacilityDetails::class.java)
