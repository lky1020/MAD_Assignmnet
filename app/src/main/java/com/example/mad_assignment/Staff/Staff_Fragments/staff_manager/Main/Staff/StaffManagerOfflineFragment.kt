...
class StaffManagerOfflineFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root:View = inflater.inflate(R.layout.staff_fragment_manager_offline, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView.adapter = StaffManagerAdapter(java.util.ArrayList<Staff>(), requireActivity()) //Initialize adapter
        recyclerView.setHasFixedSize(true)

        staffManagerModel.retrieveOnlineStaffFromDB("Offline")
